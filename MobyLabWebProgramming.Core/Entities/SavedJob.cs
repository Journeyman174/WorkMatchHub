namespace MobyLabWebProgramming.Core.Entities
{
    ...
    public class SavedJob : BaseEntity
    {
        ...
        // Relatie de tip Many-to-One: un utilizator poate salva mai multe joburi
        ...
        // Relatie de tip Many-to-One: o oferta poate fi salvata de mai multi utilizatori
        public Guid JobOfferId { get; set; }

        // Proprietate de navigare catre oferta de job care a fost salvata
